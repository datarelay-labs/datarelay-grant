...
The current repository baseline identifies Engineering System **1.6.0** and keeps patent-described concepts, accepted product requirements, implemented behavior, and roadmap behavior explicitly separated.
